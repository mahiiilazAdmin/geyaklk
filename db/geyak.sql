...
CREATE TABLE IF NOT EXISTS `geyaklk`.`t_property` (
  ...
  `p_promoid` INT NOT NULL,
  PRIMARY KEY (`p_id`),
  INDEX `fk_t_property_t_user_idx` (`p_uid` ASC),
  INDEX `fk_t_property_t_city1_idx` (`p_cid` ASC),
  INDEX `fk_t_property_t_promotion1_idx` (`p_promoid` ASC),
...
CREATE TABLE IF NOT EXISTS `geyaklk`.`t_feature` (
  ...
  PRIMARY KEY (`f_id`),
  INDEX `fk_t_feature_t_property1_idx` (`f_pid` ASC),
...
CREATE TABLE IF NOT EXISTS `geyaklk`.`t_photo` (
  ...
  PRIMARY KEY (`pi_id`),
  INDEX `fk_t_photo_t_property1_idx` (`pi_pid` ASC),
