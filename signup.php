                ...
                <div class="limiter">
                    <div class="container-login100">
                        <div class="wrap-login100 bshadow">
                            ...
                            <form action="query/signup_p.php" method="post" role="form" class="login100-form validate-form">
                                ...
                                <div class="wrap-input100 validate-input" data-validate="Mobile Number is required">
                                    <input class="input100" type="text" name="cnum" placeholder="Phone Number">
                                    <span class="focus-input100"></span>
                                    <span class="symbol-input100">
                                ...
                                <!-- Confirm Password is temp taken off -->
                                ...
                                <div class="container-login100-form-btn">
                                    ...
                                    <input type="submit" id="submit" name="submit" value="Register" class="login100-form-btn" >
                                </div>
